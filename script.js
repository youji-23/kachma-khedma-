document.addEventListener("DOMContentLoaded", function() {
    ...
    // جلب البيانات من التخزين المحلي أو تهيئة مصفوفة فارغة إذا لم تكن هناك بيانات
    const workers = JSON.parse(localStorage.getItem("workers")) || {};
    let currentUser = null;

    // عرض بيانات الباحثين عن العمل
    ...
    // الوظائف المتاحة (يمكنك إضافة ميزة إدخال الوظائف أيضاً)
    const jobs = [];
    ...
    // تحميل بيانات المستخدم عند إعادة زيارة الموقع
    ...
    // تسجيل الباحث عن العمل وحفظ البيانات في التخزين المحلي
